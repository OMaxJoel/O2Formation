...
class ScriptStyle {
	...
	public static function load_admin_scripts_styles() {
		...
		if ( ( is_admin() && 'post.php' === $pagenow && 'page' === $typenow ) || ( is_admin() && 'admin.php' === $pagenow ) ) {
			...
			array(
				'backend'               => array(
					...
					'data' => array(
						...
						'editorSettings'            => function_exists( 'get_block_editor_settings' ) ? get_block_editor_settings( array(), new \WP_Block_Editor_Context() ) : (object) array(),
